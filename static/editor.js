...
class Stackedit {
  ...
  openFile(file = {}, silent = false) {
      ...
      const targetDom = document.querySelector(this.$options.targetDom)
      targetDom.appendChild(this.$containerEl)
      ...
      // Remove body scrollbars
          targetDom.className += ' stackedit-no-overflow'
      }
  }
  ...
  close() {
      ...
      // Clean everything
          ...
          const targetDom = document.querySelector(this.$options.targetDom)
          targetDom.removeChild(this.$containerEl)
          ...
          targetDom.className = targetDom.className.replace(/\sstackedit-no-overflow\b/, '')
